...
public class user_list_hierarchy_FragmentDialog extends android.support.v4.app.DialogFragment {
    ...
    public void data_fetch() {
        try {
            ...
            RealmResults<POJO_User_S> result_query1 = mRealm.where(POJO_User_S.class).equalTo("enabled", 1).findAll().sort("modified", Sort.DESCENDING);
    ...
    public void Bind_data_listview() {
        try {
            ...
            if (ParameterStockiestForm.equals("OBJ")) {
                if (designation.equals("ABM")) {
                    result_query1 = mRealm.where(POJO_User_S.class).equalTo("abm", user_id).contains("designation", "TBM", INSENSITIVE).findAll();//.contains("enabled", 1, INSENSITIVE)
                } else if (designation.equals("RBM")) {
                    result_query1 = mRealm.where(POJO_User_S.class).equalTo("rbm", user_id).findAll();
                } else if (designation.equals("SM")) {
                    result_query1 = mRealm.where(POJO_User_S.class).equalTo("sm", user_id).findAll();
                } else if (designation.equals("ZBM")) {
                    result_query1 = mRealm.where(POJO_User_S.class).equalTo("zbm", user_id).findAll();
                } else if (designation.equals("CRM")) {
                    result_query1 = mRealm.where(POJO_User_S.class).equalTo("crm", user_id).findAll();
                } else if (designation.equals("NBM")) {
                    result_query1 = mRealm.where(POJO_User_S.class).equalTo("nbm", user_id).findAll();
                } else if ((designation.equals("Head of Marketing and Sales")) || (designation.equals("HR Manager") || (designation.equals("Administrator")))) {
                    result_query1 = mRealm.where(POJO_User_S.class).findAll().sort("modified", Sort.DESCENDING);
                ...
                if (designation.equals("ABM")) {
                    ...
                    result_query1 = mRealm.where(POJO_User_S.class).equalTo("rbm", user_id).contains("designation", "TBM", INSENSITIVE).findAll();
                } else if (designation.equals("SM")) {
                    result_query1 = mRealm.where(POJO_User_S.class).equalTo("sm", user_id).contains("designation", "TBM", INSENSITIVE).findAll();
                } else if (designation.equals("ZBM")) {
                    result_query1 = mRealm.where(POJO_User_S.class).equalTo("zbm", user_id).contains("designation", "TBM", INSENSITIVE).findAll();
                } else if (designation.equals("CRM")) {
                    result_query1 = mRealm.where(POJO_User_S.class).equalTo("crm", user_id).contains("designation", "TBM", INSENSITIVE).findAll();
                } else if (designation.equals("NBM")) {
                    result_query1 = mRealm.where(POJO_User_S.class).equalTo("nbm", user_id).contains("designation", "TBM", INSENSITIVE).findAll();
                } else if ((designation.equals("Head of Marketing and Sales")) || (designation.equals("HR Manager") || (designation.equals("Administrator")))) {
                    result_query1 = mRealm.where(POJO_User_S.class).contains("designation", "TBM", INSENSITIVE).findAll().sort("modified", Sort.DESCENDING);
                    //String emp = "EMP/712263";  //vinayak code-
                    //employee_filter = mRealm.where(POJO_User.class).equalTo("enabled", 1).contains("sm", user_id, INSENSITIVE).contains("designation", "TBM", INSENSITIVE).findAll();
                } else if (designation.equals("TBM")) {
                    //ll_spinner_tbm_patches.setVisibility(View.GONE);
